...
from src.insight_chat.prompts import (
    INSIGHT_CHAT_EXPLAIN_PROMPT_VERSION,
    INSIGHT_CHAT_EXPLAIN_SYSTEM_PROMPT,
    INSIGHT_CHAT_EXPLAIN_USER_PROMPT_TEMPLATE,
)
from src.insights.domain import Insight

InsightChatExplainMode = Literal["explain", "why", "next-steps"]
...
class InsightChatExplainerLLM:
    prompt_version: str = INSIGHT_CHAT_EXPLAIN_PROMPT_VERSION
    ...
    def explain(
        ...
        *,
        ...
        mode: InsightChatExplainMode,
    ) -> dict[str, str]:
        user_prompt = INSIGHT_CHAT_EXPLAIN_USER_PROMPT_TEMPLATE.format(
            prompt_version=INSIGHT_CHAT_EXPLAIN_PROMPT_VERSION,
            mode=mode,
        ...
        try:
            completion = self.llm.complete_json(system_prompt=INSIGHT_CHAT_EXPLAIN_SYSTEM_PROMPT, user_prompt=user_prompt)
...
def _fallback_explanation(*, insight: Insight, mode: InsightChatExplainMode) -> dict[str, str]:
    mode_text: dict[InsightChatExplainMode, str] = {
