...
class InsightPlannerLLM(InsightPlannerPort):
    ...
    def plan(
        ...
        *,
        ...
        if max_actions == 0:
            trimmed_plan: list[_PlanStep] = []
        else:
            trimmed_plan = proposal.proposed_plan[:max_actions]

        # Validación de tools: nombre permitido + args_schema básico.
